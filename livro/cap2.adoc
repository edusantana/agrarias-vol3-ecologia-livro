...
.Ecossistema
image::{img}/fig3.jpg[scaledwidth="40%"]
...
.Pirâmide Alimentar
image::{img}/fig5.jpg[scaledwidth="50%"]
...
.Pirâmide de Número
image::{img}/fig6.pdf[scaledwidth="50%"]

=== Pirâmide de Biomassa

.Pirâmide de Número
image::{img}/fig7.pdf[scaledwidth="50%"]
...
.Pirâmide de Energia
image::{img}/fig8.jpg[scaledwidth="60%"]
